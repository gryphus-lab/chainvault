...
describe('Overview (with live events)', () => {
  ...
  it('filters by search', async () => {
    ...
    fireEvent.change(screen.getByPlaceholderText('Search by Doc ID or Title...'), {
      target: { value: 'second' },
    })
  ...
  it('filters by date', async () => {
    ...
    for (const filter of dateFilter) {
      ...
      expect(screen.queryByText('Really Old Migration')).not.toBeInTheDocument() // older than 30d should never be displayed
    }
  })
